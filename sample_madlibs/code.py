def madlib():
    ...
    madlib = f"I love computer programing because it's {adj1}! The journey to becoming a \
        good programmer starts with hope in your mind and a dream in your {body_part}. Though blood, \
